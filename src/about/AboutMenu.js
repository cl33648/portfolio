...
export default class AboutMenu extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      activeMenuItem: 1,    //This means it will start with 'Personal' Menu Item
      activeSubheading: 1   //This means it will start with '1' Data (About Me) from SubheadingsData.js
    };
  }
